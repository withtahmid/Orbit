...
export const NewPasswordStep = observer(() => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await completeReset.mutateAsync({ password });
            setSuccess(true);
    ...
    if (success) {
        return (
            <div className="signup-step">
                <div className="signup-step__icon" style={{ background: "rgba(34, 197, 94, 0.1)", color: "#22c55e", borderColor: "rgba(34, 197, 94, 0.2)" }}>
